...
public class ExpenseFragment extends Fragment {
    ...
    private Spinner categorySpinnerE; // Spinner for category selection
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        categorySpinnerE = view.findViewById(R.id.categorySpinnerE); // Initialize the category spinner
